...
public class Utils {
    ...
    public static void filter(Runner runner, Filter filter)
    ...
    public static Runner createRunner(Class<? extends Runner> runnerClass,
            Class<?> testClass) {
    ...
    public static <A extends Annotation> A findAnnotation(Class<?> clazz,
        ...
        if (!Annotation.class.isAssignableFrom(clazz)) {
            for (Annotation ann : clazz.getAnnotations()) {
                annotation = findAnnotation(ann.annotationType(),
                        annotationType);
                if (annotation != null) {
                    return annotation;
                }
